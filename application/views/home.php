...
<div class="header" style="height:70px;background:white;padding:2px;margin:0;">
        ...
        <h1>PT. Widiarta Sukses</h1>
      <p><b>Kerja keras, Kerja cerdas, Kerja ikhlas</b></p>
      <p>Jl Kebayan No. 11 Sumbawa Besar</p>
      </div>
		<div style="float:right; line-height:3px; text-align:center;">
        <br /><br />
        <h1>Aplikasi Money Tracker</h1>
